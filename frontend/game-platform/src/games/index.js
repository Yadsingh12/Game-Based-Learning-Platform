...
import SetupScene from "./SnakeAndLadders/scenes/SettingUpScene";
import SignsAndLaddersScene from "./SnakeAndLadders/scenes/SignsAndLadders";
...
export const gamesMap = {
  ...
  "Signs And ladders": {
    ...
    scene: [SetupScene, SignsAndLaddersScene], // replace with your Snake and Ladders scene later
    logoPath: "/assets/images/color-game-logo.png",
    alt: "Game Logo",
