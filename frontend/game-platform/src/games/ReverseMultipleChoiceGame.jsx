...
// Reverse multiple choice - shows image, user picks correct video
...
export default function ReverseMultipleChoiceGame(props) {
  ...
  const getValidSigns = (items) => {
    return items.filter(sign => sign.name && sign.videoUrl && sign.visual);
  };
        ...
        <div className="flex flex-col items-center min-h-full max-w-5xl mx-auto">
          ...
          {showInstructions && (
            <div className="text-xs sm:text-sm bg-white/80 backdrop-blur-md shadow-xl p-3 sm:p-4 rounded-xl sm:rounded-2xl mb-2 sm:mb-3 w-full border border-white/60 animate-in fade-in slide-in-from-top duration-300">
              <p className="mb-2 font-semibold text-gray-700">Look at the image and find the matching video sign!</p>
              <ul className="text-xs text-gray-600 space-y-1 list-disc list-inside">
                <li>Observe the image/visual carefully</li>
                <li>Watch the 4 video options</li>
                <li>Click on the video that matches the image</li>
          ...
          {!roundOver ? (
            <>
              ...
              <div className="mb-3 sm:mb-4 w-full">
                <div className="bg-white/80 backdrop-blur-sm shadow-lg p-3 sm:p-4 rounded-xl sm:rounded-2xl border-2 border-white/60">
                  <p className="text-sm sm:text-lg md:text-xl font-bold text-center text-gray-800 flex items-center justify-center gap-2">
                    <Eye size={20} className="sm:w-6 sm:h-6" style={{ color: colors.primary }} />
                    <span className="text-sm sm:text-base md:text-lg">Look at the image and find the matching video</span>
                  </p>
                </div>
              </div>
              ...
              <div className="mb-4 sm:mb-6 w-full flex flex-col items-center">
                <div className="bg-white/80 backdrop-blur-md rounded-xl sm:rounded-2xl shadow-2xl border-4 border-white/50 p-4 sm:p-6 max-w-sm">
                  ...
                  <p className="text-center mt-3 sm:mt-4 text-lg sm:text-xl font-bold text-gray-800">
            ...
            <div className="text-center mb-4 mt-4 sm:mt-8 animate-in fade-in zoom-in duration-500 w-full">
              <div className="bg-white/80 backdrop-blur-md rounded-xl sm:rounded-2xl p-6 sm:p-8 shadow-2xl border border-white/60 mb-4 sm:mb-6">
                ...
                {/* Show correct answer with video */}
                <div className="mt-4 sm:mt-6 p-3 sm:p-4 bg-gray-50 rounded-xl">
                  <p className="text-xs sm:text-sm text-gray-600 mb-2 sm:mb-3">Correct Video:</p>
