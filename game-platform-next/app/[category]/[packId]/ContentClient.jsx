...
import { Lock, Star, CheckCircle, Book, Brain, Gamepad2, Zap,
         ...
         Hash, Palette, Move } from 'lucide-react';
import gameTemplatesData from '@/data/gameTemplates.json';
import { getProgress, isGameUnlocked } from '@/lib/storage';  // ← path change
              ...
              return (
                ...
                >
                  <div className="flex items-center justify-between mb-4">
                    <Icon style={{ color: unlocked ? category.colorScheme.primary : '#9ca3af' }} size={32} />
                    {unlocked
                      ? progress.completed && <CheckCircle className="text-green-500" size={24} />
