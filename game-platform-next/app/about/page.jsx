        ...
        <div className="bg-white rounded-3xl shadow-2xl p-8 sm:p-12">
          ...
          <div className="space-y-8 text-gray-600">
            <section>
              ...
              <p>An interactive platform to learn Indian Sign Language (ISL) through
              games, quizzes, and visual aids.</p>
            </section>
            <section>
              <h2 className="text-xl font-bold text-gray-800 mb-3">How it works</h2>
              <p>Pick a category — alphabets, numbers, colors, fruits, and more.
            ...
            <section>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                {[
                  ['📖','Learn'],['🧠','Quiz'],['🃏','Match'],
                  ['🔍','Find in Image'],['🔤','Word Search'],['🔀','Word Scramble'],
                  ['✏️','Crossword'],['🏓','Breakout'],['🪣','Bucket Sort'],
                ].map(([icon, name]) => (
            ...
            <section>
              ...
              <p>Once a pack is loaded, all videos and images are cached in memory.</p>
            </section>
          </div>
